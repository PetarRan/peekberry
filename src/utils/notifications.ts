/**
 * User notification system for Peekberry
 * Provides non-intrusive notifications that work across different websites
 */
...
class NotificationManager {
  ...
  /**
   * Show authentication error with re-auth action
   */
